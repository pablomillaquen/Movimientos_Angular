...
ng.module('smart-table')
  .controller('stTableController', ['$scope', '$parse', '$filter', '$attrs', function StTableController ($scope, $parse, $filter, $attrs) {
    ...
    var propertyPrintName = $attrs.stTable + "Print";
    var displayPrintGetter = $parse(propertyPrintName);
    var displayPrintSetter = displayPrintGetter.assign;

    //console.log($attrs.stTable);
    var safeGetter;
    ...
    function updateSafeCopy () {
      //console.log('start updateSafeCopy');
    ...
    this.pipe = function pipe () {
      ...
      displayPrintSetter($scope, filtered);
